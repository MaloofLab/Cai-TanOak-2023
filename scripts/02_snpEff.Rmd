...
cp /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/12_21_tanoak_CDS.fa cds.fa

cp /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/12_21_tanoak_aa.fa protein.fa

cd /usr/local/bin/snpEff
/usr/local/opt/openjdk/bin/java -jar snpEff.jar build -gff3 -v tanoak.v1221
```
...
```{bash, eval=FALSE}
cd /usr/local/bin/snpEff
/usr/local/opt/openjdk/bin/java -jar snpEff.jar dump tanoak.v1221   | head -n 40
```
...
time /usr/local/opt/openjdk/bin/java -Xmx8g -jar /usr/local/bin/snpEff.jar tanoak.v1221 /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/cohort.all.genotyped.vcf.gz > /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/cohort.all.genotyped.snpEff.vcf
...
ln -s /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/cohort.all.genotyped.snpEff.vcf.bgz ~/git/TanOak/output

ln -s /Volumes/GoogleDrive/Shared\ drives/TanOak/new_12_2021_assembly/cohort.all.genotyped.snpEff.vcf.bgz.tbi ~/git/TanOak/output
