...
DO NOT USE.  INSTEAD OF LOOKING AT ALL SNPS, ONLY LOOK AT SNPS PREDICTED TO CAUSE A CODING CHANGE.  SEE SCRIPTS 05 AND 06.
...
```{r}
R.utils::gzip("../output/fisherp.csv")
```
